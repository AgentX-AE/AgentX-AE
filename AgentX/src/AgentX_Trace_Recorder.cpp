...
class AgentXTraceRecorder : public IControllerPlugin, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IControllerPlugin, AgentXTraceRecorder, "AgentXTraceRecorder", "CounterBasedTRR.")
  private:
    IDRAM* m_dram;
