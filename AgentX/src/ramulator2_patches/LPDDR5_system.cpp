...
class LPDDR5System final : public IMemorySystem, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IMemorySystem, LPDDR5System, "LPDDR5", "A LPDDR5-based memory system.");
