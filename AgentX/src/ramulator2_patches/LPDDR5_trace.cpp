...
class LPDDR5Trace : public IFrontEnd, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IFrontEnd, LPDDR5Trace, "LPDDR5Trace", "Read/Write LPDDR5 address vector trace.")
  ...
  public:
    void init() override {
      ...
      m_logger = Logging::create_logger("LPDDR5Trace");
