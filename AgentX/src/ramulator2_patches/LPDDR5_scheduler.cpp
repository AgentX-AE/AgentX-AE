...
class LPDDR5Scheduler : public IScheduler, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IScheduler, LPDDR5Scheduler, "LPDDR5", "LPDDR5 DRAM Scheduler.")
  private:
    IDRAM* m_dram;
