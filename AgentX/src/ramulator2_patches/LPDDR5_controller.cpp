...
class LPDDR5Controller final : public IDRAMController, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IDRAMController, LPDDR5Controller, "LPDDR5Controller", "A generic DRAM controller.");
  private:
